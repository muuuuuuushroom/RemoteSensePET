...
def visualization(samples, targets, pred, queries, vis_dir, split_map=None):
    """
    ...
    for idx in range(images.shape[0]):
        ...
        # img_path = targets[idx]['image_path']
        # sample_vis = cv2.imread(img_path)
        ...
        #     sample_vis = cv2.circle(sample_vis, (int(q[1]*w), int(q[0]*h)), size, (255, 0, 0), -1)
        ...
        #     sample_vis = split_map * 0.5 + sample_vis
    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        if distributed:
            ...
            metric_logger.update(
                mae=results_reduced['mae'],
                mse=results_reduced['mse'],
            )
        else:
        ...
        if vis_dir:
            ...
            visualization(samples, targets, [points], outputs_queries, vis_dir, split_map=split_map)
